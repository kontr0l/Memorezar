...
val IndigoLight = Color(0xFF7A71F0)   // brand purple, primary in dark mode
val IndigoDark = Color(0xFF7A71F0)    // brand purple, primary in light mode
...
val PurpleLight = Color(0xFF7A71F0)   // brand purple
val PurpleDark = Color(0xFF7A71F0)    // brand purple
